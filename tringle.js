...
window.addEventListener('DOMContentLoaded', (event) => {
                ...
                if (point.y <= this.tip) {
                    if (point.y >= this.y) {
                        if (point.x >= this.x2) {
                            ...
                            this.slope = (this.basey / this.basex)*-1
    ...
    let tringle = new Triangle(350, 350, "yellow", 50)
    let observer = new Observer(350, 500, 1, "red", 400, 30, Math.PI*.5)
    observer.obstacles.push(tringle)
